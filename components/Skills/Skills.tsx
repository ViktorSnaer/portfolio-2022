...
`,
    ...
    </svg><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
    ...
    },
    {
      ...
      subHeading: "Connecting the website to a database to store information",
    },
    {
      __html: `<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
  ...
  return (
    <div className={`screen-size ${styles.topContainer}`}>
      <h3 className={`section-title`} style={{ margin: "1rem 0" }}>
        What I Offer
      </h3>
